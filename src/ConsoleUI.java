...
public class ConsoleUI {
    private final SystemZarzadzania system;
    private final BazaLogowan baza;
    private final Scanner scanner;

    public ConsoleUI(SystemZarzadzania system, BazaLogowan baza) {
        this.system = system;
        this.baza = baza;
    ...
    public void start() {
        ...
        switch (zalogowany) {
            case Admin a -> uruchomMenuAdmina(user);
            case Wykladowca w -> uruchomMenuWykladowcy(user, w);
            case Student s -> uruchomMenuStudenta(user, s);
            case null, default -> System.out.println("Blad krytyczny: Nieznany typ uzytkownika.");
        }
    }


    private void uruchomMenuAdmina(Optional<Uzytkownik> user) {
    ...
    private void uruchomMenuWykladowcy(Optional<Uzytkownik> user, Wykladowca w) {
    ...
    private void uruchomMenuStudenta(Optional<Uzytkownik> user, Student s) {
    ...
    private void wyswietlMenuWykladowcy() {
        System.out.println("\n--- MENU WYKLADOWCY ---");
    ...
    private void wyswietlPanelZarzadzaniaKursem() {
    ...
    private void wyswietlPanelStudentaKursu() {
        System.out.println("\n--- MENU KURSU ---");
    ...
    private int wczytajLiczbe(Scanner scanner, String prompt) {
        while (true) {
    ...
    private LocalDate wczytajDate(Scanner scanner, String prompt) {
        while (true) {
            System.out.print(prompt);
            String input = scanner.nextLine().trim();
            try {
    ...
    private String wczytajNiepustyTekst(Scanner scanner, String prompt) {
        while (true) {
            System.out.print(prompt);
            String input = scanner.nextLine().trim();
            if (input.isEmpty()) {
    ...
    private float wczytajOcene(Scanner scanner, String prompt) {
        while (true) {
            System.out.print(prompt);
